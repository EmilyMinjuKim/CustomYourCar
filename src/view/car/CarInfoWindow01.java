...
public class CarInfoWindow01 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CarInfoWindow01 window = new CarInfoWindow01();
	...
	public CarInfoWindow01() {
		initialize();
	}

	private void initialize() {
		frame = new JFrame("스마트");
		...
		ImageIcon car = new ImageIcon("images/orange1.png");
		...
		JLabel lblNewLabel_2 = new JLabel("스마트");
		...
		JLabel lblNewLabel0 = new JLabel("                                  스마트");
		...
		JLabel lblNewLabel = new JLabel("SBC 캐스퍼                 는 경형 SUV에 최적화된 성능을 발휘하는 ");
		...
		JLabel lblNewLabel1 = new JLabel("스마트스트림 1.0엔진을 활용하여 14.3km/L의 연비로 효율적인 드라이빙을 하실 수 있습니다.");
		...
		JLabel lblNewLabel3 = new JLabel(" 다이내믹하고 재미있는 드라이빙을 선사합니다.");
