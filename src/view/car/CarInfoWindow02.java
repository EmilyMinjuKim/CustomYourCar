...
public class CarInfoWindow02 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CarInfoWindow02 window = new CarInfoWindow02();
	...
	private void initialize() {
		...
		ImageIcon car = new ImageIcon("images/khakii1.png");
		...
		JLabel lblNewLabel_2 = new JLabel("모던");
		...
		JLabel lblNewLabel0 = new JLabel("                                    모던");
		...
		JLabel lblNewLabel = new JLabel("SBC 캐스퍼            은 경형 SUV에 최적화된 성능을 발휘하는");
		...
		JLabel lblNewLabel1 = new JLabel("카파 1.0 터보엔진을 사용하여 16.8km/L의 연비로 효율적인 드라이빙을 하실 수 있습니다.");
		...
		JLabel lblNewLabel3 = new JLabel("시스템이 자동으로 속도를 변속해주어 편안하고 안전한 드라이빙을 선사합니다.");
